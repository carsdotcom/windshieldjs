...
function WrappedHandler(handler) {
    // Hapi16: We have to pass the reply interface to the handler to invoke it.
    // Hapi17: Replace reply with the response toolkit, h (technically this code doesn't really change much)
