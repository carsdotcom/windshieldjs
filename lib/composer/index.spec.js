...
describe("composer", function () {
    ...
    it("should use component adapter if it exists", function (done) {
        spyOn(mocks, 'componentAdapter1').and.callThrough();
        spyOn(internals, 'require').and.returnValue(mocks.componentAdapter1);
        composer.call(mocks.windshieldCallContext, mocks.genericContext, mocks.pageAdapter).then(function (page) {
            ...
            expect(mocks.componentAdapter1).toHaveBeenCalledWith(mocks.component1.data);
            done();
        });
    });
