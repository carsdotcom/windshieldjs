...
module.exports = function () {
    ...
    function generateMapper(association, assocName) {
        return [ assocName, _.map(association, function (component) {
            ...
            try  {
                adapter = require(path.join(self.settings.rootDir, (self.settings.paths[component.component] || path.join('components', component.component)), 'adapter'));
            } catch (e) {
                try {
                    ...
                    adapter = function () {
                        return new Promise(function (resolve, reject) {
                            self.server.log('could not find adapter or Model for `' + component.component + '` component', { error: true });
                            resolve(component);
                        });
                    };
                }
