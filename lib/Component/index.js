...
function Component(implementation, componentName) {
    ...
    self.evaluate = function (definition, context, request, calledName) {

        var promise;
        var componentData = _.merge({}, definition.data, implementation.defaults, {componentName, calledName});
    ...
    self.render = function (definition, context, request, assocName, calledName) {

        return self.evaluate(definition, context, request, calledName).then(function (result) {
