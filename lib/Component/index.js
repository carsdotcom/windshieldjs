...
function Component(implementation, componentName) {
    ...
    function formatAdapterInput(definition, calledName) {
     ...
     * @param {module:processRoutes.Context} context - Windshield route context
     * @param {Request} request - Hapi request object
     * @param {string} calledName - Name of the component in the Windshield component map
     *
     * @return {Promise.<PrerenderedComponent>}
     */
    component.evaluate = function (definition, context, request, calledName) {
        let adapterInput = formatAdapterInput(definition, calledName);
     ...
     */
    component.render = function (definition, context, request, associationName, calledName) {

        return component.evaluate(definition, context, request, calledName)
            .then(function ({data, exported}) {
                let templateName = definition.layout || associationName;
...
/**
 * @typdef {Object} PrerenderedComponent
