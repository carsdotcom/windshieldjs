            ...
            return Promise.all(Object.keys(associations).map(function(assocName) {
                ...
                return Promise.all(associationPromises)
                    .then(function(components) {
                        ...
                        // The clone below a temporary fix until we're able to sort through an existing issue with this statement
                        //_.assign(associations[assocName], components);
                        _.assign(associations[assocName], _.map(components, _.clone));
